...
<div class="container-fluid px-0">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="badge bg-white text-primary px-3 py-2 fw-bold mb-2 rounded-pill">
                        <i class="bi bi-cpu-fill me-1"></i> UAS Pemrograman Web 2 (NIM Genap)
                    </span>
                    <h3 class="fw-bold mb-1">Modul Evaluasi Fuzzy Manajemen Belajar</h3>
                    <p class="mb-0 text-white-50">Sistem Inferensi Fuzzy Tsukamoto untuk Penentuan Rekomendasi Beban SKS Mahasiswa UMB</p>
                </div>
                <div class="text-end d-none d-md-block">
                    <span class="fs-1 fw-bold text-warning d-block">{{ $jatahSksMaksimal }} SKS</span>
                    <small class="text-white-50">Hasil Output Crisp (Defuzzifikasi)</small>
                </div>
            </div>
        </div>
    </div>

    <!-- ROW CARD INDIKATOR INPUT FUZZY -->
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <small class="text-muted d-block font-monospace">Variabel Input 1</small>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <small class="text-muted d-block font-monospace">Variabel Input 2</small>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <small class="text-muted d-block font-monospace">Variabel Input 3</small>
    ...
    <!-- MATRIKS ATURAN (RULE BASE) & HASIL -->
    <div class="row g-4 mb-4">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white py-3 border-0">
                    <h6 class="fw-bold mb-0 text-dark">
                        <i class="bi bi-diagram-3 text-primary me-2"></i> Evaluasi Rule Base (Mamdani/Tsukamoto)
                    </h6>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light text-muted small">
                                <tr>
                                    <th class="ps-4">Rule ID</th>
                                    <th>Kombinasi Syarat (IF)</th>
                                    <th>Keputusan SKS (THEN)</th>
                                    <!-- 🟢 KODE BARU (Sudah Rapi): -->
<th class="text-end pe-4">Alpha Fire (&alpha;)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="table-success table-opacity-10">
                                    ...
                                    <td class="text-end pe-4 fw-bold text-success">1.0 (Aktif)</td>
                                </tr>
                                <tr>
                                    <td class="ps-4">R2</td>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 bg-dark text-white p-4 h-100">
                <h6 class="fw-bold text-warning mb-3">
                    <i class="bi bi-check-circle-fill me-2"></i> Output Rekomendasi
                </h6>
                <div class="mb-3">
                    <small class="text-white-50 d-block">Kategori Rekomendasi:</small>
                    <span class="fs-5 fw-bold text-info">{{ $kategori }}</span>
                </div>
                <div class="mb-3">
                    <small class="text-white-50 d-block">Kuota SKS Diberikan:</small>
                    <span class="display-5 fw-bold text-warning">{{ $jatahSksMaksimal }} SKS</span>
                </div>
                <hr class="border-secondary">
                <p class="small text-white-50 mb-0">
                    <i class="bi bi-info-circle me-1"></i> Nilai crisp dihitung secara otomatis menggunakan formula rata-rata terbobot (Weighted Average Defuzzification).
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
            <h6 class="fw-bold mb-0 text-dark">
                <i class="bi bi-database-check text-success me-2"></i> Log Perhitungan Database (`fuzzy_results`)
            </h6>
            <span class="badge bg-light text-dark border">Persistensi Real-time</span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped align-middle mb-0">
                    <thead class="bg-light text-muted small">
                        <tr>
                            ...
                            <th>Nilai Tugas</th>
                            <th>Keaktifan</th>
                            <th>Hasil SKS Crisp</th>
                            <th>Kategori</th>
                            <th class="text-end pe-4">Waktu Eksekusi</th>
                        </tr>
                    </thead>
                    <tbody>
